...
const generateTabsClassName = (orientation: string, className?: string) => {
  return cn(
...
const generateTabsTriggerClassName = (variant: string, className?: string) => {
  return cn(
...
function Tabs({ className, orientation = "horizontal", ...props }: TabsPrimitive.Root.Props) {
  return (
    <TabsPrimitive.Root
      ...
      className={generateTabsClassName(orientation, className)}
      {...props}
    />
  )
}
