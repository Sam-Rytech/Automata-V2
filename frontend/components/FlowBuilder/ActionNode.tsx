...
const renderNodeCard = ({ data, selected, color }: { data: ActionNodeData; selected: boolean; color: string }) => (
  <div className="relative bg-[#12121A] border p-5 w-[240px] transition-all shadow-xl z-10 {
...
const renderGlowingBrackets = ({ selected, color }: { selected: boolean; color: string }) => {
