...
const ModelLogo = ({
  ...
  <motion.div whileHover={{ scale: 1.05 }} className="flex items-center gap-3 group cursor-pointer">
    ...
    <span
      className="hidden sm:block font-syne font-bold text-lg tracking-wider text-white/30 transition-all duration-500 group-hover:text-[#10A37F] group-hover:drop-shadow-[0_0_15px_rgba(16,163,127,0.4)]"
      style={{
        color: color,
        textShadow: `0 0 15px rgba(${color}, 0.4)`,
      }}
    >
      {text}
    </span>
