...
function Tabs({ className, orientation = "horizontal", ...props }: TabsPrimitive.Root.Props) {
  return (
    <TabsPrimitive.Root data-slot="tabs" data-orientation={orientation} className={cn(
...
function getTabsTriggerClassName(className: string, variant: string, orientation: string) {
  return cn(
    ...
    `after:absolute after:bg-foreground after:opacity-0 after:transition-opacity group-data-${orientation}/tabs:after:inset-x-0 group-data-${orientation}/tabs:after:bottom-[-5px] group-data-${orientation}/tabs:after:h-0.5 group-data-${orientation}/tabs:after:w-0.5 group-data-[variant=line]/tabs-list:data-active:after:opacity-100`,
    className
  )
}
...
function TabsTrigger({ className, ...props }: TabsPrimitive.Tab.Props) {
  ...
  return (
    <TabsPrimitive.Tab data-slot="tabs-trigger" className={getTabsTriggerClassName(className, 'default', orientation)} {...props} />
  )
}
