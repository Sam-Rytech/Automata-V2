      ...
      <div className="bg-[#1A1A2E]/60 border border-[#E91E8C]/40 p-6 rounded-none relative backdrop-blur-md">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-6 pt-8 border-t border-white/10">
          ...
          <div className="flex gap-4 w-full sm:w-auto">
            ...
            <button onClick={onApprove} disabled={isExecuting} className="flex-1 sm:flex-none px-8 py-3 bg-[#E91E8C] text-white font-mono text-[10px] uppercase tracking-widest font-black transition-all hover:bg-[#E91E8C]/80 disabled:opacity-50 flex items-center justify-center gap-2">
              {isExecuting ? 'SYNCING...' : 'Approve & Execute'}
