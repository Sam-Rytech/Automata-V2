...
// Extracted sigmoid function
vec4 sigmoid(vec4 x){
  return 1./(1.+exp(-x));
}

// Extracted matrix multiplication function
vec4 multiplyMat4Vec4(mat4 m, vec4 v) {
  return m * v;
}
