...
const styles = {
  ...
  divider: 'h-px w-24 bg-gradient-to-r from-transparent via-[#E91E8C]/50 to-transparent mb-8',
  ...
  scanline: 'absolute inset-0 bg-gradient-to-b from-white/0 via-white/20 to-white/0 translate-y-[-100%] group-hover:translate-y-[100%] transition-transform duration-700 ease-in-out',
