...
const AutomataLogo = () => (
  <div className="w-32 h-32 sm:w-40 sm:h-40 rounded-full bg-white/5 border border-white/10 flex items-center justify-center shadow-[0_0_20px_rgba(255,255,255,0.08)] backdrop-blur-sm">
    <img src="/Automata.png" alt="Automata" className="w-20 h-20 sm:w-24 sm:h-24 object-contain" />
  </div>
);
...
const X402Logo = () => (
  <div className="w-32 h-32 sm:w-40 sm:h-40 rounded-full bg-white/5 border border-white/10 flex items-center justify-center shadow-[0_0_20px_rgba(86,132,209,0.15)] backdrop-blur-sm group cursor-pointer transition-all hover:bg-white/10 hover:shadow-[0_0_30px_rgba(86,132,209,0.25)]">
    <div className="w-20 h-20 sm:w-24 sm:h-24 transition-colors duration-300 bg-white/80 group-hover:bg-[#5684D1]" style={{
    ...
    <section className="relative py-24 border-b border-[var(--border-subtle)] bg-[#0A0A10] overflow-hidden z-10">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="flex-1 w-full max-w-2xl lg:max-w-none">
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.2 }} className="group relative">
            ...
            <div className="relative rounded-xl overflow-hidden bg-[#0F0F1A] border border-[var(--border-subtle)] shadow-2xl">
              ...
              <div className="flex items-center px-4 py-3 border-b border-[var(--border-subtle)] bg-black/40">
                ...
                <div className="flex-1 text-center font-mono text-[0.65rem] text-white/40 tracking-wider">x402.ts</div>
              </div>
              {/* Code Content */}
