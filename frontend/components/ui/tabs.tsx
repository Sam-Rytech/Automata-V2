...
function getTabsTriggerClassName(variant: string, className?: string) {
  return cn(
...
function TabsTrigger({ className, ...props }: TabsPrimitive.Tab.Props) {
  return (
    <TabsPrimitive.Tab data-slot="tabs-trigger" className={getTabsTriggerClassName("default", className)} {...props} />
  )
}
