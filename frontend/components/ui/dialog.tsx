...
const getDialogClasses = (className?: string) => {
  return cn(
...
const getDialogContentClasses = (className?: string) => {
  return cn(
...
function DialogOverlay({ className, ...props }: DialogPrimitive.Backdrop.Props) {
  return <DialogPrimitive.Backdrop data-slot="dialog-overlay" className={getDialogClasses(className)} {...props} />
}
...
function DialogContent({ className, children, showCloseButton = true, ...props }: DialogPrimitive.Popup.Props & { showCloseButton?: boolean }) {
  return (
    <DialogPortal>
      <DialogOverlay />
      <DialogPrimitive.Popup data-slot="dialog-content" className={getDialogContentClasses(className)} {...props}>
        {children}
        {showCloseButton && (
