...
function getTooltipClassName(className: string): string {
  return cn(
...
function getArrowClassName(side: string): string {
  return cn(
    "z-50 size-2.5 translate-y-[calc(-50%-2px)] rotate-45 rounded-[2px] bg-foreground fill-foreground",
    {
      'bottom': 'top-1',
      'inline-end': 'top-1/2! -left-1 -translate-y-1/2',
      'inline-start': 'top-1/2! -right-1 -translate-y-1/2',
