...
function renderOpportunity(opp: YieldOpportunity, index: number, onDeposit: (opportunity: YieldOpportunity) => void) {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        {opportunities.slice(0, 5).map((opp, i) => renderOpportunity(opp, i, onDeposit))}
      </div>
    </motion.div>
  );
}
