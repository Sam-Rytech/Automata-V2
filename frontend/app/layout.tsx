...
const createFont = (font, subsets, variable, weights) => {
  return font({
    subsets,
    variable,
    weight: weights,
...
const syne = createFont(Syne, ['latin'], '--font-syne', ['400', '500', '600', '700', '800']);
const plexMono = createFont(IBM_Plex_Mono, ['latin'], '--font-plex-mono', ['400', '500', '600', '700']);
